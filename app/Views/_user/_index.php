        ...
        <div class="page-header d-print-none">
          <div class="row align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
              <div class="btn-list">
                <a href="#" class="btn btn-indigo d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#modal-report">
              ...
              <div class="col-md-6 col-lg-12">
                <div class="card">
                  <div class="card-body p-4 text-center">
                    <span class="avatar avatar-xl mb-3 avatar-rounded" style="background-image: url(<?=base_url()?>/assets/static/avatars/profile.JPG)"></span>
                    ...
                    ?>
                      <div class="mt-3">
                      <a style="outline:none" id="btn-datang" table-id='<?php ?>' href="#" class="btn btn-indigo" data-bs-toggle="modal" data-bs-target="#confirm-absen-datang"><!-- Download SVG icon from http://tabler-icons.io/i/mail -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-check" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">   <path stroke="none" d="M0 0h24v24H0z" fill="none"/>   <circle cx="12" cy="12" r="9" />   <path d="M9 12l2 2l4 -4" /> </svg>
                      Absen Datang
                      </a>
                      </div>
                    <?php
                    ...
                    ?>
                      <div class="mt-3">
                      <a style="outline:none" id="btn-pulang" href="#" class="btn btn-indigo" data-bs-toggle="modal" data-bs-target="#confirm-absen-pulang"><!-- Download SVG icon from http://tabler-icons.io/i/mail -->
                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-check" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">   <path stroke="none" d="M0 0h24v24H0z" fill="none"/>   <circle cx="12" cy="12" r="9" />   <path d="M9 12l2 2l4 -4" /> </svg>
                      Absen Pulang
                      </a>
                      </div>
        ...
        <div class="modal-status bg-indigo"></div>
          <div class="modal-body text-center py-4">
            ...
            <div class="form-group">
                <input type="hidden" id="txt_abs_id" value="<?php if(isset($dataabsen->abs_id)) {echo $dataabsen->abs_id;}?>">
